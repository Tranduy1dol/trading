...
```mermaid
graph TD
    MAIN["main.rs (binary)"] --> ADAPT["adapters"]
    ...
    style DOM fill:#2d5a27,stroke:#4a9,color:#fff
    style APP fill:#1a4a6a,stroke:#49a,color:#fff
    style ADAPT fill:#6a3a1a,stroke:#a94,color:#fff
```

Domain **cannot** import application or adapters. This is enforced by the compiler.
